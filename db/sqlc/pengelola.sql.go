...
const createPengelola = `-- name: CreatePengelola :one
...
type CreatePengelolaParams struct {
...
func (q *Queries) CreatePengelola(ctx context.Context, arg CreatePengelolaParams) (Pengelola, error) {
	row := q.db.QueryRowContext(ctx, createPengelola,
		arg.Nama,
		arg.Ktp,
		arg.Jabatan,
		arg.Alamat,
